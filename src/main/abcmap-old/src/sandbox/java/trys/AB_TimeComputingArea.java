 ...
 *
 */
public class AB_TimeComputingArea {

	/*
	 * Résultats:
	 * 
	 * Début des mesures... Nombre de changements de valeurs: 100 100 essais.
	 * Moyenne: 0.008 s. Minimum: 0.0 s. Maximum: 0.049 s.
	 * 
	 * Début des mesures... Nombre de changements de valeurs: 33 100 essais.
	 * Moyenne: 0.007 s. Minimum: 0.0 s. Maximum: 0.021 s.
	 * 
