...
public class BackgroundTexture {
	...
	public boolean equals(Object obj) {
		...
		// ne pas comparer texture ou image
	...
	private void createTexture() {
		...
		// Piste possible pour ameliorer la qualité
		// texture.createContext(cm, deviceBounds, userBounds, xform, hints);
	}
